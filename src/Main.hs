...
main = do
  ...
  let getConnection h p
      ...
      commands = mconcat [complimentCommands, evalCommands, merriamWebsterCommands, moonCommands, nLabCommands, translateCommands, wolframAlphaCommands, wikimediaCommands]
